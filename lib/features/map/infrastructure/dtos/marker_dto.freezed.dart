...
mixin _$MarkerDto {
 ...
 String get id;@JsonKey(fromJson: _latLngFromJson, toJson: _latLngToJson) LatLng get position;@JsonKey(name: 'marker_type') MarkerType get type; String get title; String get description; double get width; double get height;@JsonKey(fromJson: _colorFromJson, toJson: _colorToJson) Color get color; double get borderWidth;@JsonKey(fromJson: _colorFromJson, toJson: _colorToJson) Color get borderColor;
...
@override
String toString() {
  return 'MarkerDto(id: $id, position: $position, type: $type, title: $title, description: $description, width: $width, height: $height, color: $color, borderWidth: $borderWidth, borderColor: $borderColor)';
}
...
@useResult
$Res call({
 String id,@JsonKey(fromJson: _latLngFromJson, toJson: _latLngToJson) LatLng position,@JsonKey(name: 'marker_type') MarkerType type, String title, String description, double width, double height,@JsonKey(fromJson: _colorFromJson, toJson: _colorToJson) Color color, double borderWidth,@JsonKey(fromJson: _colorFromJson, toJson: _colorToJson) Color borderColor
});
...
class _MarkerDto implements MarkerDto {
  const _MarkerDto({this.id = '', @JsonKey(fromJson: _latLngFromJson, toJson: _latLngToJson) required this.position, @JsonKey(name: 'marker_type') this.type = MarkerType.pointOfInterest, this.title = '', this.description = '', this.width = 40.0, this.height = 40.0, @JsonKey(fromJson: _colorFromJson, toJson: _colorToJson) this.color = Colors.red, this.borderWidth = 2.0, @JsonKey(fromJson: _colorFromJson, toJson: _colorToJson) this.borderColor = Colors.white});
...
@override@JsonKey(fromJson: _colorFromJson, toJson: _colorToJson) final  Color borderColor;
